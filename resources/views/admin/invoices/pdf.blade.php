...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ТРИ КОЛОНИ КАТО ТАБЛИЦА САМО БЕЗ РАМКИ ВЪТРЕ */
        ...
        .invoice-number-large { font-size: 10pt; font-weight: bold; }
        .invoice-date-large { font-size: 8pt; font-weight: bold; }
        
        /* ПОЛЕТА В ТАБЛИЦА БЕЗ РАМКА ЗА ТЕКСТОВИТЕ ПОЛЕТА */
        .info-table {
            width: 100%;
            margin-bottom: 1.5mm;
            /* БЕЗ РАМКА ЗА ЦЯЛАТА ТАБЛИЦА */
            border: none;
        }
        .label-cell {
            width: 15mm;
        ...
        .col-discount-percent { width: 7%; }
        .col-discount-amount { width: 9%; }
        .col-subtotal { width: 9%; }
        .col-vat-percent { width: 6%; }
        .col-vat-amount { width: 9%; }
        .col-total { width: 13%; }
        ...
        <tr>
            <td class="client-box">
                ...
                <table class="info-table">
                    <tr><td class="label-cell">Клиент:</td><td class="value-cell">{{ $invoice->customer->name ?? 'Няма данни' }}</td></tr>
                    <tr><td class="label-cell">Град:</td><td class="value-cell">{{ $invoice->customer->city ?? '' }}</td></tr>
                    <tr><td class="label-cell">Адрес:</td><td class="value-cell">{{ $invoice->customer->address ?? '' }}</td></tr>
                    <tr><td class="label-cell">ЕИК / ЕГН:</td><td class="value-cell">{{ $invoice->customer->vat_number ?? '' }}</td></tr>
                    <tr><td class="label-cell">ЗДДС №:</td><td class="value-cell">{{ $invoice->customer->vat_number ?? '______' }}</td></tr>
                    <tr><td class="label-cell">МОЛ:</td><td class="value-cell">{{ $invoice->customer->contact_person ?? '' }}</td></tr>
                    <tr><td class="label-cell">IBAN:</td><td class="value-cell">{{ $invoice->customer->iban ?? '' }}</td></tr>
                    <tr><td class="label-cell">Банка:</td><td class="value-cell">{{ $invoice->customer->bank_name ?? '' }}</td></tr>
                    <tr><td class="label-cell">BIC:</td><td class="value-cell">{{ $invoice->customer->bic ?? '' }}</td></tr>
                </table>
            </td>
            ...
            <td class="supplier-box">
                ...
                <table class="info-table">
                    ...
                    @endphp
                    <tr><td class="label-cell">Доставчик:</td><td class="value-cell">{{ $company['name'] }}</td></tr>
                    <tr><td class="label-cell">Град:</td><td class="value-cell">{{ $company['city'] }}</td></tr>
                    <tr><td class="label-cell">Адрес:</td><td class="value-cell">{{ $company['address'] }}</td></tr>
                    <tr><td class="label-cell">ЕИК / ЕГН:</td><td class="value-cell">{{ $company['vat_number'] }}</td></tr>
                    <tr><td class="label-cell">ЗДДС №:</td><td class="value-cell">{{ $company['vat_number'] }}</td></tr>
                    <tr><td class="label-cell">МОЛ:</td><td class="value-cell">{{ $company['contact_person'] }}</td></tr>
                    <tr><td class="label-cell">IBAN:</td><td class="value-cell">{{ $company['iban'] }}</td></tr>
                    <tr><td class="label-cell">Банка:</td><td class="value-cell">{{ $company['bank_name'] }}</td></tr>
                    <tr><td class="label-cell">BIC:</td><td class="value-cell">{{ $company['bic'] }}</td></tr>
                </table>
            </td>
        </tr>
    </table>
