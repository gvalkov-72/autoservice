    ...
    <tr>
        ...
        <td>
            @if ($invoice->workOrder)
                <a href="{{ route('admin.work-orders.show', $invoice->workOrder->id) }}">
                    №{{ $invoice->workOrder->old_id }}
                </a>
            @else
                —
            @endif
        ...
        <td class="text-center">
            <div class="btn-group btn-group-sm" role="group">
                <a href="{{ route('admin.invoices.show', $invoice->id) }}" class="btn btn-outline-primary"
                    title="Преглед">
                ...
                @endif
                <a href="{{ route('admin.invoices.print', $invoice->id) }}" class="btn btn-outline-secondary"
                    title="Печат" target="_blank">
                    <i class="fas fa-print"></i>
                </a>
                <a href="{{ route('admin.invoices.pdf', $invoice->id) }}" class="btn btn-outline-danger" title="PDF"
                    target="_blank">
