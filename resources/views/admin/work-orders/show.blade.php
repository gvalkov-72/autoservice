...
<div class="container-fluid">
    ...
    <div id="print-template" style="display: none;">
        @include('admin.work-orders.print', ['work_order' => $work_order, 'rate' => $rate, 'showBgn' => $showBgn])
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <dl class="row mb-0">
                                ...
                                <dd class="col-sm-8">{{ $work_order->mileage ? number_format($work_order->mileage, 0, ',', ' ') . ' км' : '—' }}</dd>
                            ...
                            <tbody>
                                ...
                                <tr class="table-info">
                                    ...
                                    <td colspan="2" class="text-right font-weight-bold">
                                        ...
                                        @if($showBgn)
                                        <br><small class="text-muted">{{ toBgn($work_order->service_amount, $rate) }} лв</small>
                                        @endif
                                    </td>
                                </tr>
                                @endif
            ...
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mt-3 pt-3 border-top">
...
<style>
    ...
    @media print {
        ...
        .no-print, .btn, .card-header, .content-header, 
        .card-footer, .sidebar, .main-footer,
        .alert, .content-header, .breadcrumb {
