...
@section('title', 'Редактиране на услуга')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1>Редактиране на услуга: {{ $service->name }}</h1>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="is_active" id="is_active" 
                                ...
                                <option value="1" {{ old('is_active', $service->is_active) ? 'selected' : '' }}>Активна</option>
                                <option value="0" {{ !old('is_active', $service->is_active) ? 'selected' : '' }}>Неактивна</option>
                            </select>
                            @error('is_active')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
